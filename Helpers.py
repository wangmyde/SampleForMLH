...
def gradient_check_weights(layers, input_tensor, label_tensor, bias):
    ...
    while not it.finished:
        ...
        for layer in layers[:-1]:
            ...
            #print('plus_epsilon_activation=',plus_epsilon_activation)
        ...
        for layer in layers[:-1]:
            ...
            #print('minus_epsilon_activation=',minus_epsilon_activation)
        ...
        #print('analytical_derivative.shape=',analytical_derivative)
